...
// Only admins should be able to print PDS
requireAdmin();
...
// Decode other_info JSON and merge additional fields for display
...
<body>
    <div class="no-print" style="text-align:right;margin-bottom:10px;">
        ...
        <a href="dashboard.php" style="padding: 8px 12px; background: #6c757d; color: white; text-decoration: none; border-radius: 4px; margin-left: 5px;">Back to Admin</a>
    </div>
